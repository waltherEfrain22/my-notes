...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
      appBar: AppBar(title: const Text('Probando Bloc'),
...
class CounterStateValid extends CounterState{
  const CounterStateValid(int value) : super(value); // dame un value y despues yo llamo a mi super clase con un value
}
...
abstract class CounterEvent{
  final String value;
 const CounterEvent(this.value);  //any value just go directly into the counter
}
